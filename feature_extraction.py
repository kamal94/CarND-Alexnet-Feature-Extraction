...
W_last = tf.Variable(tf.random_normal([shape[0], shape[1]], mean=0, stddev=0.1))
b_last = tf.Variable(tf.random_normal([nb_classes], mean=0, stddev=0.1))
logits = tf.add(tf.matmul(fc7, W_last), b_last)
